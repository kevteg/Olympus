...
QJoystickEnumerator::QJoystickEnumerator(QString directory, QWidget *parent) : QDialog(parent), mDirectory(directory), ui(new Ui::QJoystickEnumerator) {
    ui->setupUi(this);
...
void QJoystickEnumerator::refreshList() {
    ...
    DIR* dir;
    struct dirent *dirp;
    dir = opendir(mDirectory.toLatin1().data());
